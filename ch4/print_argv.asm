; print_argv - outputs all strings in argv array to stdout
; Compilation: make print_argv
; Usage: ./print_argv arg1 arg2 arg3
; =======================================================================================
global start
...
start:
    ...
    ; write all strings in argv to stdout
    mov rax, rsp 
    push r14
    push r15
